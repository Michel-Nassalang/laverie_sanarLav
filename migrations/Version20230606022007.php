 ...
 */
final class Version20230606022007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, tel VARCHAR(50) DEFAULT NULL, adresse VARCHAR(100) DEFAULT NULL, role VARCHAR(50) NOT NULL, mdp VARCHAR(255) NOT NULL, date_create DATETIME DEFAULT NULL, date_update DATETIME DEFAULT NULL, date_delete DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
